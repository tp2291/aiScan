...
public class OauthHelper {
    ...
    public Optional<OAuthTokenInfo> getAccessToken(
        ...
        if (hasTokenExpired.test(key)) {
           log.warn("Access Token Null or Expired");
            if(hasRefreshTokenExpired.test(key)){
                log.warn("Refresh Token Null or expired. Creating new Access Token!");
                ...
                log.warn("Refresh Token not expired. Creating new access token using refresh token.");
