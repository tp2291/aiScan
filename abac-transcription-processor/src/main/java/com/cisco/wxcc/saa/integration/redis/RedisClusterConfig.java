...
public class RedisClusterConfig {
    ...
    private String getRedisPassword() throws ConfigurationException {
        Properties redisCreds = ConfigHelper.loadFromFile(redisCredsFilePath);
        return redisCreds.getProperty(AppConstants.PASSWORD);
    }

    public RedisAdvancedClusterAsyncCommands<String, String> redisAsyncCommands() throws ConfigurationException {
